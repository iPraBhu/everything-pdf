  ...
  return (
    <div className="h-full flex flex-col items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Watermark Tool</h2>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              This feature will allow you to add text or image watermarks to your PDF files with customizable positioning and opacity.
            </p>
          </div>
        </div>
      </div>
